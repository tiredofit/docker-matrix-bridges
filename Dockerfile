...
ENV DISCORD_VERSION=${DISCORD_VERSION:-"v0.4.0"} \
    ...
    SLACK_VERSION=${SLACK_VERSION:-"cb748dbc825f3aa310408f215470aea67eb736bb"} \
    TELEGRAM_VERSION=${TELEGRAM_VERSION:-"v0.13.0"} \
    TWITTER_VERSION=${TWITTER_VERSION:-"v0.1.5"} \
    WHATSAPP_VERSION=${WHATSAPP_VERSION:-"v0.9.0"} \

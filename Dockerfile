...
ENV DISCORD_VERSION=${DISCORD_VERSION:-"v0.6.5"} \
    ...
    META_VERSION=${META_VERSION:-"v0.4.1"} \
    SIGNAL_VERSION=${SIGNAL_VERSION:-"ad41c86f116f484a57b7df07bc082f33fc12d908"} \
    SLACK_VERSION=${SLACK_VERSION:-"v0.1.2"} \
    TELEGRAM_VERSION=${TELEGRAM_VERSION:-"v0.15.1"} \
    WHATSAPP_VERSION=${WHATSAPP_VERSION:-"v0.11.0"} \
